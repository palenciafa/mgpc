        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-8">
                <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
                    ...
                    <!-- Contact Number -->
                    <div>
                        <label for="contact" class="block text-sm font-medium text-white mb-3">
                            Contact Number
                        </label>
                        <input type="text" name="contact" id="contact" value="{{ old('contact') }}"
                            placeholder="Enter contact number..."
                            class="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50">
                    </div>
                    ...
                    <!-- Address -->
                    <div>
                        <label for="address" class="block text-sm font-medium text-white mb-3">
                            Address
                        </label>
                        <textarea name="address" id="address" rows="3" placeholder="Enter supplier address..."
                            class="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50">{{ old('address') }}</textarea>
                    </div>
            ...
            <div class="mt-6 bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-blue-300 text-sm">
                        <p>Suppliers help you manage product sources and streamline inventory tracking. Ensure accurate
                            supplier details for efficient operations.</p>
                    </div>
                </div>
            </div>
        </div>
