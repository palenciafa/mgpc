...
<div class="min-h-screen bg-slate-900/90 px-6 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-white mb-1">Edit Category</h1>
        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-8">
            ...
            <div class="flex items-center mb-6 pb-6 border-b border-slate-700/50">
                ...
                <div>
                    ...
                    <p class="text-slate-400 text-sm">Category ID: #{{ $category->id }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-400">Update the category name as needed</p>
                </div>
        ...
        <div class="mt-6 bg-red-500/10 border border-red-500/20 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-red-400 text-sm mb-3">Once you delete a category, there is no going back. Please be certain.</p>
        ...
        <div class="mt-4 text-center">
            <p class="text-slate-500 text-sm">
                ...
                @else
                    Created: {{ $category->created_at->format('M d, Y \a\t g:i A') }}
                @endif
            </p>
        </div>
    </div>
