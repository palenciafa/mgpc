...
<div class="min-h-screen bg-slate-900/90 px-6 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-white mb-1">Add New Category</h1>
                <p class="text-slate-400">Create a new product category</p>
            </div>
        </div>
        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-8">
            <form method="POST" action="{{ route('categories.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-400">Choose a clear, descriptive name for your category</p>
                </div>
        ...
        <div class="mt-6 bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            <div class="flex">
                ...
                <div>
                    <h4 class="text-blue-300 font-medium mb-1">Tips for creating categories:</h4>
                    <ul class="text-blue-400 text-sm space-y-1">
                        ...
                        <li>• Consider how products will be organized under this category</li>
                    </ul>
                </div>
            </div>
        </div>
