        ...
        <div class="text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl p-6 border border-slate-700/50 hover:shadow-2xl hover:bg-slate-800/70 transition-all duration-300">
                    ...
                    <div class="h-2 w-full bg-slate-700/50 rounded-full mt-4">
                ...
                <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl p-6 border border-slate-700/50 hover:shadow-2xl hover:bg-slate-800/70 transition-all duration-300">
                    ...
                    <div class="h-2 w-full bg-slate-700/50 rounded-full mt-4">
                        <div class="h-2 bg-gradient-to-r from-red-500 to-red-400 rounded-full transition-all duration-1000" style="width: {{ $salesCount > 0 ? min($salesCount * 2, 100) : 0 }}%"></div>
                    </div>
                </div>
            </div>
            </a>
