        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-slate-700/50 p-8">
            ...
            <div class="flex items-center mb-6 pb-6 border-b border-slate-700/50">
                <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mr-4">
                    <span class="text-white font-bold text-lg">{{ strtoupper(substr($product->name, 0, 2)) }}</span>
                </div>
                <div>
                    <h3 class="text-xl font-semibold text-white">{{ $product->name }}</h3>
                    <p class="text-slate-400 text-sm">Product ID: #{{ $product->id }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-400">Update the product name as needed</p>
                </div>
